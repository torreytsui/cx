...
func buildApp(dir, ver string) error {
	if _, err := cmd("goxc", "-include=''", "-bc=linux,windows,darwin,freebsd,cxdist", "-pv="+ver, "-d="+publishDir, "-main-dirs-exclude=Godeps,testdata,_project,vendor", "-n=cx", "-wd="+dir); err != nil {
		return err
	}
	return nil
}
